...
FORM set_data_main .
  ...
  calc_date_in_interval due_date '1' due_date_n1.
  calc_date_in_interval due_date '2' due_date_n2.
  calc_date_in_interval due_date '3' due_date_n3.
  calc_date_in_interval due_date '4' due_date_n4.
  calc_date_in_interval due_date '5' due_date_n5.
  calc_date_in_interval due_date '6' due_date_n6.
  calc_date_in_interval due_date '7' due_date_n7.
  calc_date_in_interval due_date '8' due_date_n8.
  calc_date_in_interval due_date '12' due_date_n12.

  "get data from acdoca
  SELECT prctr,segment,kunnr,racct,belnr,budat,bldat,SUM( hsl ) AS hsl
  FROM acdoca
  INTO TABLE @DATA(gt_acdoca)
  WHERE rbukrs = @p_bukrs AND racct IN @s_racct  AND segment IN @s_segm  AND
        budat BETWEEN @due_date_n12 AND @due_date  AND
        prctr IN @s_prctr  AND koart = 'D' AND rldnr = '0L' AND
        kunnr IN @s_kunnr
  GROUP BY prctr,segment,kunnr,racct,belnr,budat,bldat.

  SORT gt_acdoca BY prctr kunnr racct belnr budat.
  IF p_stt IS NOT INITIAL.
    ...
    LOOP AT gt_acdoca INTO DATA(ls_acdoca).
      READ TABLE gt_cong_no WITH KEY prctr = ls_acdoca-prctr segment = ls_acdoca-segment kunnr = ls_acdoca-kunnr TRANSPORTING NO FIELDS.
      IF sy-subrc NE 0.
        DELETE gt_acdoca.
      ENDIF.
    ENDLOOP.
  ...
  "buid data for display
  LOOP AT gt_acdoca INTO DATA(gs_acdoca).
    gs_data-prctr = gs_acdoca-prctr.
    gs_data-segment = gs_acdoca-segment.
    READ TABLE gt_cn INTO DATA(gs_cn) WITH KEY prctr = gs_acdoca-segment.
    IF sy-subrc IS INITIAL.
      gs_data-pstcode = gs_cn-pstcode.
      gs_data-ten_cn = gs_cn-ten_cn.
    ENDIF.
    gs_data-waers = 'VND'.
    gs_data-kunnr = gs_acdoca-kunnr.
    READ TABLE gt_knb1 INTO DATA(ls_knb1) WITH KEY kunnr = gs_acdoca-kunnr.
    IF sy-subrc = 0.
      IF ls_knb1-zterm = '0001' OR ls_knb1-zterm = '0002' OR ls_knb1-zterm = 'D001' OR ls_knb1-zterm = 'D002'.
        IF gs_acdoca-budat > due_date_n1 AND gs_acdoca-budat <= due_date.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n1 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n1 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311106000'.
            gs_data-voso_n1 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311105000'.
            gs_data-vtsale_n1 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311109000'.
            gs_data-log_n1 = gs_acdoca-hsl.
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n2 AND gs_acdoca-budat <= due_date_n1.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n2 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n2 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311106000'.
            gs_data-voso_n2 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311105000'.
            gs_data-vtsale_n2 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311109000'.
            gs_data-log_n2 = gs_acdoca-hsl.
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n5 AND gs_acdoca-budat <= due_date_n2.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n3 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n3 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311106000'.
            gs_data-voso_n3 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311105000'.
            gs_data-vtsale_n3 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311109000'.
            gs_data-log_n3 = gs_acdoca-hsl.
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n12 AND gs_acdoca-budat <= due_date_n5.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n6 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n6 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311106000'.
            gs_data-voso_n6 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311105000'.
            gs_data-vtsale_n6 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311109000'.
            gs_data-log_n6 = gs_acdoca-hsl.
          ENDIF.
        ENDIF.
      ELSEIF ls_knb1-zterm = 'D003' OR ls_knb1-zterm = 'D004'.
        IF gs_acdoca-budat > due_date_n2 AND gs_acdoca-budat <= due_date_n1.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n1 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
          ...
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n3 AND  gs_acdoca-budat <= due_date_n2.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n2 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n2 = gs_acdoca-hsl.
          ...
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n6 AND gs_acdoca-budat <= due_date_n3.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n3 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n3 = gs_acdoca-hsl.
          ...
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n12 AND gs_acdoca-budat <= due_date_n6.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n6 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n6 = gs_acdoca-hsl.
      ...
      ELSEIF ls_knb1-zterm = 'D005'.
        IF gs_acdoca-budat > due_date_n3 AND gs_acdoca-budat <= due_date_n2.
          ...
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n4 AND  gs_acdoca-budat <= due_date_n3.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n2 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n2 = gs_acdoca-hsl.
          ...
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n7 AND gs_acdoca-budat <= due_date_n4.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n3 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n3 = gs_acdoca-hsl.
          ...
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n12 AND gs_acdoca-budat <= due_date_n7.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n6 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n6 = gs_acdoca-hsl.
      ...
      ELSEIF ls_knb1-zterm = ''.
        ...
        IF gs_acdoca-budat > due_date_n5 AND gs_acdoca-budat <= due_date_n2.
          ...
          ENDIF.
        ENDIF.
        IF gs_acdoca-budat > due_date_n6 AND gs_acdoca-budat <= due_date_n5.
          IF gs_acdoca-racct = '1311103000'.
            gs_data-cpn_n6 = gs_acdoca-hsl.
          ELSEIF gs_acdoca-racct = '1311101000'.
            gs_data-vpp_n6 = gs_acdoca-hsl.
      ...
      ENDIF.
    ENDIF.
*    gs_data_amount = CORRESPONDING #( gs_data ).
*    COLLECT gs_data_amount INTO gt_data_amount.
    COLLECT gs_data INTO gt_data1.
    CLEAR: gs_data. ", gs_data_amount.
  ENDLOOP.
  ...
  gt_data = CORRESPONDING #( gt_data1 ).
ENDFORM.
*&---------------------------------------------------------------------*
*& Form DISPLAY_DATA
*&---------------------------------------------------------------------*
...
FORM display_data_0100.
  IF p_stt = 1 OR p_stt IS INITIAL. "trang thai da phe duyet thi hien thi so tien con lai
    ...
    LOOP AT gt_data ASSIGNING FIELD-SYMBOL(<fs_data>).
      READ TABLE lt_cong_no_tmp WITH KEY prctr = <fs_data>-prctr segment = <fs_data>-segment kunnr = <fs_data>-kunnr INTO DATA(ls_cong_no_tmp).
      IF sy-subrc = 0.
...
*                      lpw_alv TYPE REF TO cl_gui_alv_grid
                      CHANGING lpt_container TYPE REF TO cl_gui_custom_container
                      lpt_data TYPE ANY TABLE.
  DATA: lt_fcat TYPE lvc_t_fcat.
  PERFORM get_container_common USING lpw_cont_name lpw_struc_name CHANGING lpt_container lt_fcat.
  PERFORM get_fcat USING lpw_cont_name lpw_struc_name CHANGING lt_fcat.
  PERFORM set_alv_common USING lpw_cont_name lpw_struc_name lpt_data lt_fcat lpt_container.
ENDFORM.
*&---------------------------------------------------------------------*
...
FORM get_container_common  USING p_container TYPE char10
  ...
  get REFERENCE OF c_cont INTO ref.
  IF c_cont IS BOUND.
...
*                           p_alv TYPE REF TO cl_gui_alv_grid
  ...
  DATA :o_spli1   TYPE REF TO cl_gui_splitter_container.
*  DATA :lo_cont_main TYPE REF TO cl_gui_container.
*  DATA(lo_container) = NEW cl_gui_custom_container( container_name =  p_container ).
*  DATA(lo_split) = NEW cl_gui_splitter_container( parent  = lo_container rows = 2 columns = 1 ).
*  IF gt_container IS BOUND.
*    gt_container->free( ).
*  ENDIF.
*  gt_container = NEW cl_gui_custom_container( container_name =  p_container ).
...
*  g_alv = NEW cl_gui_alv_grid( i_parent = lo_cont_main ).
  g_alv = NEW cl_gui_alv_grid( i_parent = p_cont ).
...
*  ls_layout_src-no_toolbar = 'X'.
*  ls_layout-handle = p_container.
...
*    LEAVE TO SCREEN 0100.
  ...
  LOOP AT gt_data_import INTO ls_import.
    ...
    READ TABLE gt_data WITH KEY prctr = ls_import-prctr segment = ls_import-segment kunnr = lw_cusid TRANSPORTING NO FIELDS.
    IF sy-subrc NE 0.
...
FORM build_row_display.
  ...
  LOOP AT gt_data_dn INTO DATA(ls_data_dn).
    READ TABLE gt_data WITH KEY prctr = ls_data_dn-prctr kunnr = |{ ls_data_dn-kunnr ALPHA = IN }| INTO DATA(ls_data).
    IF sy-subrc = 0.
...
*  ENDLOOP.
  ...
  LOOP AT lt_cong_no_tab ASSIGNING FIELD-SYMBOL(<fs_cong_no>).
    ...
    <fs_cong_no>-thang = |{ p_budat+4(2) }|.
    <fs_cong_no>-nam = |{ p_budat+0(4) }|.
...
FORM approve .
  ...
  LOOP AT gt_data_import_valid INTO DATA(ls_data_import_valid) WHERE flag = 'X'.
    READ TABLE gt_cong_no WITH KEY prctr = ls_data_import_valid-prctr segment = ls_data_import_valid-segment kunnr = ls_data_import_valid-kunnr INTO DATA(ls_cong_no).
    IF sy-subrc = 0.
